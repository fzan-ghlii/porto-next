...
// PERBAIKAN DI SINI:
// Impor dari file 'navigation.ts' yang baru kita buat
...
export default function LanguageSwitcher() {
  ...
  const pathname = usePathname(); // Ini sekarang akan mengembalikan path tanpa locale (e.g. /about)
  const locale = useLocale();

  const handleLanguageChange = (newLocale: string) => {
    // 'router.replace' dari 'next-intl' sekarang akan bekerja
