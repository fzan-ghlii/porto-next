...
// PERBAIKAN DI SINI:
// 'useRouter' adalah untuk navigasi yang sadar-bahasa (locale-aware).
import { useRouter } from 'next-intl/navigation';
// 'usePathname' adalah untuk mendapatkan path URL saat ini (dari Next.js standar).
...
export default function LanguageSwitcher() {
  ...
  const pathname = usePathname(); // Ini akan mengembalikan /en/about atau /id/about
  const locale = useLocale();

  const handleLanguageChange = (newLocale: string) => {
    // 'router.replace' dari 'next-intl' cukup pintar
    // untuk menangani 'pathname' yang lengkap
