...
export default function ContactPage() {
  ...
  // State untuk menampilkan pesan setelah submit
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Logika pengiriman form (misalnya ke API atau EmailJS) akan ada di sini
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            {isSubmitted && (
              <div className="bg-primary/10 border border-primary text-primary p-4 rounded-md mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full inline-block bg-gradient-to-r from-primary to-secondary text-primary-foreground font-bold py-3 px-8 rounded-full transition-transform duration-300 transform hover:scale-105 shadow-custom-light dark:shadow-custom-dark"
              >
                Kirim Pesan
              </button>
            </form>
